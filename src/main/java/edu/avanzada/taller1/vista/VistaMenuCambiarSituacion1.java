...
public class VistaMenuCambiarSituacion1 extends javax.swing.JFrame {

    private ControlCambiarSituacion control;

    public VistaMenuCambiarSituacion1(ControlCambiarSituacion aThis) {
        initComponents();
        control = aThis;
    ...
    public javax.swing.ButtonGroup GrupoCambio;
